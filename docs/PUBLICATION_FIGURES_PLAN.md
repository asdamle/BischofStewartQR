...
| `fig_relative_time` | forest plot of geomean relative time per family × regime, parity line at 1; Julia: filled/open markers for 1/4 BLAS threads | single col (3.35 in) |
