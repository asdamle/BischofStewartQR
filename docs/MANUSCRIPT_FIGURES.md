...
| Figure 6 | `fig_rpqr_speedup_k256` | `matlab_rand/benchmark/plots/` |
| Figure 7 | `fig_largen_scaling` | `matlab_rand/benchmark/plots/` |
| Figure 8 | `fig_approx_cond_quality_spec` | `matlab_rand/benchmark/plots/` |
| Figure 9 | `fig_relative_time_composite` (Julia) | `julia/benchmark/results/publication/plots/` |
...
- Figure 8 is the spectral-norm variant of `fig_approx_cond_quality`
...
- Figure 9 is the Julia relative-time composite; the MATLAB pipeline renders
