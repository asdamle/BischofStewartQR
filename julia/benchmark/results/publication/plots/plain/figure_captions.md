...
Run: 20260611_204425; seeds: 2; BLAS threads: 1, 4. In all figures, BSQR is compared against CPQR (built-in); both timed paths materialize Q, R, and the permutation.
