...
%
%     manifest.csv      name,m,n,k,rinv_check,gap_min,rtol_R,rtol_rinv
...
fprintf(manifest, 'name,m,n,k,rinv_check,gap_min,rtol_R,rtol_rinv\n');
...
for idx = 1:numel(zoo)
    ...
    fprintf(manifest, '%s,%d,%d,%d,%d,%.17g,%.17g,%.17g\n', ...
        z.name, m, n, z.k, has_rinv, gap_min, z.rtol_R, z.rtol_rinv);
